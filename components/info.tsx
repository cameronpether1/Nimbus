import aircraftimg from "@/public/STAMP.svg";
import Image from "next/image";
export default function Info() {
  return (
    <div className="bg-gray-50 py-8 sm:py-11">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <p className="mx-auto mt-2 max-w-lg text-pretty text-center text-4xl font-medium tracking-tight text-gray-950 sm:text-5xl">
          Everything you need to Track your Simulation.
        </p>
          ...
          <div className="relative max-lg:row-start-1">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              ...
              <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                <Image
                  className=" w-full h-48 max-lg:max-w-xs hover:scale-105 transition"
                  src={aircraftimg}
                  alt=""
                />
              </div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Collect Stamps and share flights.
                </p>
              </div>
              <div className="flex flex-1 items-center justify-center [container-type:inline-size] max-lg:py-6 lg:pb-2">
                <Image
                  className=" w-full h-48 max-lg:max-w-xs hover:scale-105 hover:rotate-6 transition duration-300"
                  src={aircraftimg}
                  alt=""
                />
              </div>
